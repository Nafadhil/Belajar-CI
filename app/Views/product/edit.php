        ...
        <div class="col-12">
            ...
            <form action="/product/<?= $data['id'] ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="number" min="1" class="form-control" id="example-product-stock"
                        aria-describedby="emailHelp" placeholder="Enter product stock" required name="stock"
                        value="<?= $data['stock'] ?>">
                </div>

                <div class="form-group">
                    <label for="example-product-price">Price</label>
                    <input type="number" min="1" class="form-control" id="example-product-price"
                        aria-describedby="emailHelp" placeholder="Enter product price" required name="price"
                        value="<?= $data['price'] ?>">
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="category" id="example-product-category">
                        <option value="utilities" <?= $data['category'] == "utilities" ? "selected" : "" ?>>Utilities
                        </option>
